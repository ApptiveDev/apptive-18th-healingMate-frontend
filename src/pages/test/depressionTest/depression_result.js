...
import './depression_result.scss';
import depressionResult from '../../../images/depression_result_1.png';
   ...
   return(
        <div className='depressionResultP1'>
            ...
            <div className='depressionScore'>
                ...
                <div className='depression_score'>8점 </div> 
                <div className='depression_score_2'>입니다 </div>
               
            </div>

            <div className='depressionResult'><img alt='depressionResult' src={depressionResult}  ></img></div>
