...
import './stress_result.scss';
import stressResult1 from '../../../images/stress_result_1.png';
   ...
   return(
        <div className='stressResultP1'>
            ...
            <div className='StressScore'>
                ...
                <div className='stress_score'>7점 </div> 
                <div className='stress_score_2'>입니다 </div>
               
            </div>

            <div className='stressResult1'><img alt='stressResult1' src={stressResult1}  ></img></div>
