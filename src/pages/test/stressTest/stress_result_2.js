...
import './stress_result_2.scss';
import stressResult2 from '../../../images/result2_stress.png';
   ...
   return(
        <div className='stressResultP1'>
            ...
            <div className='StressScore'>
                ...
                <div className='stress_score'>22점 </div> 
                <div className='stress_score_2'>입니다 </div>
               
            </div>

            <div className='stressResult2'><img alt='stressResult2' src={stressResult2}  ></img></div>
